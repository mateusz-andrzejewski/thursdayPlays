...
export class RenderModalAddPlayer{
    ...
    addNewPlayer(){
        ...
        //zabezpieczenie przed duplikatami
            if(this.instanceOfAllPlayers.find(el=>el.name===this.modalAddPlayerCntNameStackFullNameString.value.toLowerCase())) return window.alert(`This player exists in allPlayers tab, try to find him out !😜`);
